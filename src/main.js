// Main Javascript logic for WOODCRAFT landing page
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 4. Form Submissions and Success Modal
  ...
  // 5. Lightbox for Zooming Portfolio Images
